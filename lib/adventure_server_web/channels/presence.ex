defmodule AdventureServerWeb.Presence do
  @moduledoc """
  ...
  Presences can be tracked in your channel after joining:
      ...
      defmodule AdventureServer.MyChannel do
        use AdventureServerWeb, :channel
  ...
  """
  use Phoenix.Presence, otp_app: :adventure_server,
                        pubsub_server: AdventureServer.PubSub
end
